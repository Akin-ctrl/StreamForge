    ...
    adapters = [
        ...
        CatalogAdapterType(
            ...
            fields=[
                ...
                _field("password", "Password", "password", required=False, default=""),
    ...
    sinks = [
        CatalogSinkType(
            ...
            fields=[
                ...
                _field("db_dsn", "Database DSN", "text", default="postgresql://streamforge:streamforge@timescaledb:5432/streamforge"),
            ...
            sections=[
                _section(
                    ...
                    fields=[
                        ...
                        _field("url", "Webhook URL", "text", required=False, default=""),
                        _field("webhook_url", "Slack Webhook URL", "text", required=False, default=""),
                    ],
                ),
            ],
        ),
